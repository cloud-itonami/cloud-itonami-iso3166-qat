...
Open ISO 3166 Blueprint for **QAT**: Qatar.
...
tax registration, and local-content rules in Qatar, so the operator
...
- **Not the government of Qatar.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Qatari-licensed counsel
...
(ISO 3166 `QAT`). Required capabilities:
