(ns marketentry.store
  "SSoT for the QAT market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems QA" :portal "MoF e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-qa-entity? true :has-qa-entity? true
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "QAT" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "MoF e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-qa-entity? true :has-qa-entity? true
             :requires-cr? true :cr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "MoF e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "QAT" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "MoF e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-qa-entity? true :has-qa-entity? false
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "QAT" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "MoF e-procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-qa-entity? true :has-qa-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "QAT" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "MoF e-procurement"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-qa-entity? has-qa-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-qa-entity?)  (assoc :engagement/requires-qa-entity? requires-qa-entity?)
    (some? has-qa-entity?)       (assoc :engagement/has-qa-entity? has-qa-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-qa-entity? :engagement/has-qa-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-qa-entity? (boolean (:engagement/requires-qa-entity? m))
     :has-qa-entity? (boolean (:engagement/has-qa-entity? m))
